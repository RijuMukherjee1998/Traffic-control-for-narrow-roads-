...
var server=http.createServer(function(request,response){
   //var myWriteStream=fhandler.createWriteStream(__dirname+'/t1.txt');
    ...
    form.parse(request, function (err, fields, files){
      ...
      var newpath = "C:/Users/Riju Mukherjee/Desktop/Node/image.jpg"
      console.log(oldpath);
      console.log(newpath);
       ...
       fhandler.rename(oldpath, newpath, function (err) {
         ...
         var test=new PythonShell('FirstDetection.py',opt);
  ...
  //do stuff
         ...
         var formResponse=fhandler.createReadStream(__dirname+'/t1.txt');
...
server.listen(5000,'192.168.43.58');
